...
def train(state_dim,action_dim):
    ...
    load_directory = os.path.join(os.path.dirname(os.path.abspath(os.path.dirname(__file__))),"steer&spd/models116_laser72") # save trained models
    directory = os.path.join(os.path.dirname(os.path.abspath(os.path.dirname(__file__))),"steer&spd/models117_laser72_2") # save trained models
